 ...
 * @author Ayush
 */
public class QuestionImage extends javax.swing.JFrame {
	...
	/**
     * Creates new form QuestionImage
     */
    public QuestionImage(Question question) {
    	 initComponents();
    ...
    public void loadComponents(Question question) {
    	JTextArea.setText(question.getText());
    	...
    	jRadioButton4.setText(question.getOptions().get(3));
    	   jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource(question.getImagePath()))); // NOI18N
       	jButton1.setText( "Score" + " " + StudentLoginPage.getInstance().currentScore );
    	jButton3.setValue(StudentLoginPage.getInstance().questionCount*10);
    ...
    private void initComponents() {
        ...
        jButton3 = new javax.swing.JProgressBar();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(JTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 627, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(JTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 1010, 630));
    ...
    private boolean ValidateAnswer() {
		...
		System.out.println( "ansByUser" + ansByUser + " correctAnswers" + correctAnswers);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestionImage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestionImage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JProgressBar jButton3;
